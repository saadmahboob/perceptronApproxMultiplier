...
def run_sel_test( ModelType, src_delay, sink_delay, dump_vcd, test_verilog, max_cycles=30  ):
  ...
  src_ctr_in_msgs      = [ # LD, mem_addr(0x0008) which should be 0xffff
                          ...
                          inst(ADD, inLeftNbrL2, inLeftNbrL4, outLeftNbrL1),
  ...
  src_nbr_in_msgs[rightNbrL1] = []
  src_nbr_in_msgs[leftNbrL1]  = []
  src_nbr_in_msgs[rightNbrL2] = []
  src_nbr_in_msgs[leftNbrL2]  =   [0x0002, 0x0003, 0x0004, 0x0003, 0x0005]
  #src_nbr_in_msgs[leftNbrL2]  = [0x0000, 0x0002,0x0001,0x0001,0x0001,0x0001,0x0003] #for the newly added
  src_nbr_in_msgs[rightNbrL4] = []
  src_nbr_in_msgs[leftNbrL4]  =   [0x0003, 0x0004, 0x0002, 0x0004, 0x0006]
  #src_nbr_in_msgs[leftNbrL4]  = [0x0001, 0x0003,0x0001,0x0002,0x0003,0x0004,0x0004] # for the newly added

  sink_fsm_out_msgs    = []
  sink_nbr_out_msgs[rightNbrL1] = []
  sink_nbr_out_msgs[rightNbrL1] = []              #added output here to print out.
  sink_nbr_out_msgs[leftNbrL1]  = [0x0005, 0x000f, 0x000f, 0x000f, 0x000b]
  #sink_nbr_out_msgs[leftNbrL1]  = [0x0001, 0x0006,0x0002,0x0003,0x0004,0x0005,0x000c]
  sink_nbr_out_msgs[rightNbrL2] = []
  sink_nbr_out_msgs[leftNbrL2]  = []
