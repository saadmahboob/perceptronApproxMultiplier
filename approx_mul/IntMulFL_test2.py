...
class TestHarness (Model):
  ...
  def __init__( s, imul, src_msgs, sink_msgs,
    ...
    s.src_a  = TestSource ( Bits(32) , src_msgs,  src_delay  )
    s.src_b  = TestSource ( Bits(32) , src_msgs,  src_delay  )
    s.imul = imul
    ...
    s.connect( s.src_a.out,  s.imul.a  )
    s.connect( s.src_b.out,  s.imul.b  )
